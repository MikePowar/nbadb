...
create table TeamSeasonStatistic
(seasonStartDate date,
 tname char(25),
 games_played int,
 points double(4,1),
 FG_attempted double(4,1), 
 FG_made double(4,1), 
 FG_percent double(4, 1), 
 FT_attempted double(4,1), 
 FT_made double(4,1), 
 FT_percent double(4, 1), 
 Threes_attempted double(4,1),
 Threes_made double(4,1), 
 Threes_percent double(4, 1),
 total_rebounds double(4,1), 
 offensive_rebounds double(4,1), 
 defensive_rebounds double(4,1), 
 assist double(4,1), 
 steals double(4,1), 
 personal_fouls double(4,1), 
 turnovers double(4,1), 
 blocks double(4,1), 
 PRIMARY KEY (seasonStartDate, tname),
 FOREIGN KEY (tName) REFERENCES Team(title));